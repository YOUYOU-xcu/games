...
<div class="header bg-main">
    ...
    <div class="head-l">
        <a class="button button-little bg-green" href="${path}/index/index" target="_blank"><span class="icon-home"></span> 前台首页</a> &nbsp;&nbsp;
        <a href="##" class="button button-little bg-blue"><span class="icon-wrench"></span> 清除缓存</a> &nbsp;&nbsp;
        <a class="button button-little bg-red" href="${path}/a/logout"><span class="icon-power-off"></span> 退出登录</a>
    </div>
</div>
<div class="leftnav">
...
<div style="text-align:center;">
    <p>微信公众号:<a href="http://www.yyyhs.uu710.cn/" target="_blank">佑佑有话说</a></p>
</div>
</body>
</html>